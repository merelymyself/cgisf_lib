...
pub fn cgisf(adjectives1:i32, adverbs:i32, structure:i32, plural1:bool, adjectives2:i32, plural2:bool) -> String {
	let y = get_structure(adjectives1, adverbs, structure, plural1,adjectives2, plural2);
